  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#07111f] text-white">
      ...
      <header className="relative border-b border-white/[0.07] bg-[#081525]/75 backdrop-blur-xl"><div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-6">
        <button onClick={() => router.push("/dashboard")} className="text-left"><div className="flex items-center gap-3"><img src="/campusflow-logo.svg" alt="CampusFlow logo" className="h-10 w-10 rounded-xl shadow-lg shadow-cyan-500/20" /><div><h1 className="text-lg font-bold tracking-tight">CampusFlow</h1><p className="text-[11px] text-slate-500">SMART CAMPUS OS</p></div></div></button>
